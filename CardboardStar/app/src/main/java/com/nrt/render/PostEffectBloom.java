...
public class PostEffectBloom
{
	...
	public DelayResourceQueueMarker Marker = new DelayResourceQueueMarker("PostEffectBloom");
	...
	public BlendState m_blendStateDisable = new BlendState
	(
		false, BlendFunc.SrcAlpha, BlendFunc.OneMinusSrcAlpha
	);
	
	public BlendState m_blendStateAdd = new BlendState
	(
		true, BlendFunc.One, BlendFunc.One
	);
	
	public DepthStencilState m_depthStencilState = new DepthStencilState
	(
		false, DepthFunc.Less, false
	);
	
	public RasterizerState m_rasterizerState = new RasterizerState
	(
	...
	public void Render( BasicRender br, FrameBuffer frameBufferBase )
	{
		...
		gfxc.SetBlendState(m_blendStateDisable);
		gfxc.SetDepthStencilState(m_depthStencilState);
		gfxc.SetRasterizerState(m_rasterizerState);
	...
	public void Render( BasicRender br, FrameBuffer frameBufferFrom, FrameBuffer frameBufferTo )
	{
		...
		if( gfxc == null || mc == null || frameBufferTo == null || frameBufferFrom == null )
		{
			return;
		}
	...
	public void RenderBloom( BasicRender br, FrameBuffer frameBufferFrom, FrameBuffer frameBufferTo )
	{
		...
		*/
		...
		gfxc.SetProgram(m_programBloom);
		
		gfxc.SetTexture( u_texture0, frameBufferFrom.ColorRenderTexture );
		gfxc.SetSamplerState( u_texture0, m_samplerLinear );
		...
		gfxc.DrawArrays( Primitive.TriangleStrip, 0, 3 );		
