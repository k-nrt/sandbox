...
public final class Float3
{
	...
	public static Float3 Add( Float3 dst, Float3 a, Float3 b ) { dst.X=a.X+b.X; dst.Y=a.Y+b.Y; dst.Z=a.Z+b.Z; return dst; }
	public static Float3 Sub( Float3 dst, Float3 a, Float3 b ) { dst.X=a.X-b.X; dst.Y=a.Y-b.Y; dst.Z=a.Z-b.Z; return dst; }
	public static Float3 Mul( Float3 dst, Float3 a, Float3 b ) { dst.X=a.X*b.X; dst.Y=a.Y*b.Y; dst.Z=a.Z*b.Z; return dst; }
	public static Float3 Div( Float3 dst, Float3 a, Float3 b ) { dst.X=a.X/b.X; dst.Y=a.Y/b.Y; dst.Z=a.Z/b.Z; return dst; }

	public static Float3 Add( Float3 dst, Float3 a, float b ) { dst.X=a.X+b; dst.Y=a.Y+b; dst.Z=a.Z+b; return dst; }
	public static Float3 Sub( Float3 dst, Float3 a, float b ) { dst.X=a.X-b; dst.Y=a.Y-b; dst.Z=a.Z-b; return dst; }
	public static Float3 Mul( Float3 dst, Float3 a, float b ) { dst.X=a.X*b; dst.Y=a.Y*b; dst.Z=a.Z*b; return dst; }
	public static Float3 Div( Float3 dst, Float3 a, float b ) { dst.X=a.X/b; dst.Y=a.Y/b; dst.Z=a.Z/b; return dst; }

	public static Float3 Add( Float3 dst, float a, Float3 b ) { dst.X=a+b.X; dst.Y=a+b.Y; dst.Z=a+b.Z; return dst; }
	public static Float3 Sub( Float3 dst, float a, Float3 b ) { dst.X=a-b.X; dst.Y=a-b.Y; dst.Z=a-b.Z; return dst; }
	public static Float3 Mul( Float3 dst, float a, Float3 b ) { dst.X=a*b.X; dst.Y=a*b.Y; dst.Z=a*b.Z; return dst; }
	public static Float3 Div( Float3 dst, float a, Float3 b ) { dst.X=a/b.X; dst.Y=a/b.Y; dst.Z=a/b.Z; return dst; }
	...
	public static Float3 Mad( Float3 dst, Float3 t, Float3 m, Float3 a ) { dst.X=t.X*m.X+a.X; dst.Y=t.Y*m.Y+a.Y; dst.Z=t.Z*m.Z+a.Z; return dst; }
	public static Float3 Mad( Float3 dst, Float3 t, float m, Float3 a ) { dst.X=t.X*m+a.X; dst.Y=t.Y*m+a.Y; dst.Z=t.Z*m+a.Z; return dst; }

	//public static Float3 Neg( Float3 a ) { return new Float3( -a.X, -a.Y, -a.Z ); }

	public static Float3 Neg( Float3 dst, Float3 a ) { return dst.Set( -a.X, -a.Y, -a.Z ); }

	public static Float3 Mov( Float3 dst, Float3 a )
	{
		return dst.Set( a.X, a.Y, a.Z );
	}

	public static Float3 Min( Float3 dst, Float3 a, Float3 b )
	{
		return dst.Set( 
			( a.X < b.X ? a.X : b.X),
			( a.Y < b.Y ? a.Y : b.Y),
	...
	public static Float3 Max( Float3 dst, Float3 a, Float3 b )
	{
		return dst.Set( 
			( a.X > b.X ? a.X : b.X),
			( a.Y > b.Y ? a.Y : b.Y),
	...
	public static Float3 Clamp( Float3 dst, Float3 a, Float3 min, Float3 max )
	{
	...
	public static Float3 Cross( Float3 dst, Float3 a, Float3 b)
	{
		return dst.Set(
			a.Y*b.Z - a.Z*b.Y,
			a.Z*b.X - a.X*b.Z,
	...
	public static Float3 CrossNormalize(Float3 dst, Float3 a, Float3 b)
	{
	...
	public static Float3 SubNormalize( Float3 dst, Float3 a, Float3 b )
	{
		float x = a.X - b.X;
		float y = a.Y - b.Y;
		float z = a.Z - b.Z;
...
//	}
//	
	public static Float3 Lerp( Float3 dst, float lerp, Float3 v0, Float3 v1 )
	{
		return dst.Set(
			v0.X*(1.0f-lerp) + v1.X*lerp,
			v0.Y*(1.0f-lerp) + v1.Y*lerp,
	...
	public static float LengthSquared( Float3 a )
	{
...
//	}
	...
	public static Float3 Normalize( Float3 dst, Float3 a )
	{
	...
	public static Float3 Rand( float min, float max )
	{
		float r = max - min;
	...
	public static Float3 Rand( Float3 dst, float min, float max )
	{
		float r = max - min;
	...
	public static Float3 Local() { return m_locals.Get(); }
	public static Float3 Local( float xyz ) { return m_locals.Get().Set( xyz ); }
	public static Float3 Local( float x, float y, float z ) { return m_locals.Get().Set( x, y, z ); }
