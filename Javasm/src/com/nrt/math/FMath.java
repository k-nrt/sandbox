...
public class FMath
{
	...
	public static float ToRad( float deg ) { return (deg*PI)/180.0f; }

	public static float Abs( float a ) { return ( (0.0f < a) ? a : -a );} 
	public static float Pow( float x, float y ) { return (float) Math.pow( (double) x, (double) y ); }
	public static float Cos( float rad ) { return (float) Math.cos( (double) rad ); }
	public static float Sin( float rad ) { return (float) Math.sin( (double) rad ); }
	public static float Acos( float c ) { return (float) Math.acos( (double) c ); }
	public static float Asin( float s ) { return (float) Math.asin( (double) s ); }
	public static float Atan2( float y, float x ) { return (float) Math.atan2( y, x ); }
	public static float Sqrt(float a ) { return (float) Math.sqrt( (double) a ); }
	public static float Floor( float a ) { return (float) Math.floor( (double) a); }

	public static float Lerp( float f0, float f1, float fLerp )
	{
		return f0*(1.0f-fLerp)+f1*fLerp;
	}

	public static float Clamp( float a, float fMin, float fMax )
	{
